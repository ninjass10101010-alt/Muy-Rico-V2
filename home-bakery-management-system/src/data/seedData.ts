...
export const seedInventory: InventoryItem[] = [
  ...
  { id: "inv_betty_crocker_chocolate", name: "Betty Crocker Triple Chocolate Fudge Cake Mix", category: "Baking", quantity: 5, unit: "box", reorderLevel: 2, costPerUnit: 2.50, supplier: "Costco",
    ingredients_label: "Enriched Flour Bleached (wheat flour, niacin, iron, thiamin mononitrate, riboflavin, folic acid), Sugar, Cocoa Processed with Alkali, Corn Syrup, Baking Soda, Corn Starch, Palm Oil, Salt, Artificial Flavor",
    allergens: ["Wheat"], unit_weight: 0.95 },
  { id: "inv_betty_crocker_strawberry", name: "Betty Crocker Super Moist Strawberry Cake Mix", category: "Baking", quantity: 5, unit: "box", reorderLevel: 2, costPerUnit: 2.50, supplier: "Costco",
    ingredients_label: "Enriched Flour Bleached (wheat flour, niacin, iron, thiamin mononitrate, riboflavin, folic acid), Sugar, Corn Syrup, Leavening (baking soda, sodium aluminum phosphate, monocalcium phosphate), Modified Corn Starch, Corn Starch, Propylene Glycol Mono and Diesters of Fatty Acids, Salt, Monoglycerides, Palm Oil, Natural and Artificial Flavor, Red 40",
    allergens: ["Wheat"], unit_weight: 0.95 },
  { id: "inv_betty_crocker_vanilla", name: "Betty Crocker Super Moist Vanilla Cake Mix", category: "Baking", quantity: 5, unit: "box", reorderLevel: 2, costPerUnit: 2.50, supplier: "Costco",
    ingredients_label: "Enriched Flour Bleached (wheat flour, niacin, iron, thiamin mononitrate, riboflavin, folic acid), Sugar, Corn Syrup, Leavening (baking soda, sodium aluminum phosphate, monocalcium phosphate), Modified Corn Starch, Corn Starch, Propylene Glycol Mono and Diesters of Fatty Acids, Salt, Monoglycerides, Palm Oil, Natural and Artificial Flavor",
    allergens: ["Wheat"], unit_weight: 0.95 },
  { id: "inv_frosting_vanilla", name: "Pillsbury Whipped Vanilla Frosting", category: "Baking", quantity: 6, unit: "can", reorderLevel: 2, costPerUnit: 2.00, supplier: "Costco",
    ingredients_label: "Sugar, Palm Oil, Water, Corn Syrup, Canola Oil, Corn Starch, and 2% or less of: Mono- and Diglycerides, Natural and Artificial Flavor, Modified Corn Starch, Cellulose Gel, Salt, Propylene Glycol Monostearate, Carrageenan, Polysorbate 80, Potassium Sorbate (Preservative), Cellulose Gum, Citric Acid, Sodium Stearoyl Lactylate, Antioxidants (Ascorbyl Palmitate, Mixed Tocopherols, Chamomile and Rosemary Extracts)",
    allergens: [], unit_weight: 0.92 },
  { id: "inv_frosting_strawberry", name: "Pillsbury Whipped Strawberry Frosting", category: "Baking", quantity: 6, unit: "can", reorderLevel: 2, costPerUnit: 2.00, supplier: "Costco",
    ...
    allergens: [], unit_weight: 0.92 },
  { id: "inv_frosting_chocolate", name: "Pillsbury Whipped Chocolate Frosting", category: "Baking", quantity: 6, unit: "can", reorderLevel: 2, costPerUnit: 2.00, supplier: "Costco",
    ...
    allergens: [], unit_weight: 0.92 },
  { id: "inv_wilton_coloring", name: "Wilton Gel Food Coloring Set", category: "Baking", quantity: 2, unit: "set", reorderLevel: 1, costPerUnit: 12.00, supplier: "Michaels",
    ingredients_label: "Water, Sugar, Glycerin, Sorbitol, Modified Food Starch, Potassium Sorbate, Sodium Benzoate; color-dependent FD&C dyes: Red 40, Red 3, Blue 1, Yellow 5, Yellow 6",
    allergens: [], unit_weight: 0.5 },
];
